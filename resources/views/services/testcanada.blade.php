                    ...
                    <div class="col-lg-6">
                        <div class="pr-lg-4">
                            <div class="bg-light-subtle text-center rounded-custom overflow-hidden p-lg-5 p-3 mx-lg-auto"
                                ...
                                <img src="assets/img/canrr.jpg" alt="" class="img-fluid">
                                <div
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 pb-50">
                                        <div class="tab-right-content">
                                            ...
                                            <a href="{{ route('staffing')}}" class="text-white link-with-icon text-decoration- e">
                                                Know More About Us
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="section-heading text-center">
                           ...
                           <h2> CANADA Migration Program at the Wheel</h2>
                            <p>At Vriaum, we take pride in empowering individuals to seize their dreams of starting a new chapter in Canada through our comprehensive CANADA Migration Program. With a focus on personalized guidance and a commitment to excellence, we are your trusted partner in making your Canadian aspirations a reality.</p>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="section-heading text-center mb-5">
                            ...
                            <h2 class="h2 ">Chance to learn and work in the CANADA</h2>
...
<section class="services-icon ptb-12">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="">
                        <div class="section-heading text-center">
                        <p class="h3 text-primary">Why Choose VriAum for Internship and Migrating Staffing to Canada</p>
