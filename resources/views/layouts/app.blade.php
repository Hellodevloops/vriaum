<!DOCTYPE html> <html lang="en" data-bs-theme="light"> <head> <!--required meta tags--> <meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1"> <!--meta--> <meta name="description" content="">
...
<!-- endbuild -->
    ...
    <!--custom css start-->
<link rel="stylesheet" href="assets/css/custom.css"> <style> .whats-app { position: fixed; width: 60px; height: 60px;
    bottom: 100px; background-color: #25d366; color: #FFF; border-radius: 50px; text-align: center; font-size: 30px;
    box-shadow: 2px 2px 3px #999; z-index: 100; right: 25px; } .my-float { margin-top: 16px; } </style>
<!--custom css end-->
...
<div class="main-wrapper"> <!--header section start--> <!--header start-->
    ...
    <div class="container d-flex align-items-center justify-content-lg-between position-relative">
        ...
        <a class="navbar-toggler position-absolute right-0 border-0" href="#offcanvasWithBackdrop" role="button"> ?i
            class="flaticon-menu" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBackdrop"
...
<div class="action-btns text-end me-5 me-lg-0 d-none d-md-block d-lg-block">
    ...
    <a href="https://www.canva.com/design/DAFxf09DcJw/zWAa84Pv1JLsR4NgCtipcA/view?utm_content=DAFxf09DcJw&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink&mode=preview"
        class="btn btn-primary">Download Brochure</a>
</div>
</div>
</nav>
                ...
                <div class="col-md-8 col-lg-4 mb-md-4 mb-lg-0">
                    <div class="footer-single-col">
                        <div class="footer-single-col mb-4">
                            <a href="{{ route('home') }}">
                                <img src="assets/img/Vri_logo.png" alt="logo" class="img-fluid logo-footer logo-white"
                                    style="width: 350px;" />
                                <img src="assets/img/Vri_logo.png" alt="logo" class="img-fluid logo-footer logo-color"
                                    style="width: 320px;" />
                            </a>
                        </div>
                    ...
                    <div class="footer-single-col text-start text-lg-end text-md-end">
                        <ul class="list-unstyled list-inline footer-social-list mb-0">
                            ...
                            <li class="list-inline-item"><a
                                    href="https://www.linkedin.com/company/vriaum-technologies-llc"><i
...
<script
    type="text/javascript">window.$crisp = []; window.CRISP_WEBSITE_ID = "59b8a715-3210-4497-bc12-6e3bcd6a89ed"; (function () { d = document; s = d.createElement("script"); s.src = "https://client.crisp.chat/l.js"; s.async = 1; d.getElementsByTagName("head")[0].appendChild(s); })();</script>
<!--endbuild-->
</body>
<!-- </body> -->
